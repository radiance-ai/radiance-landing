...
const Testimonials = () => {
    ...
    const testimonials = [
        {
            name: 'Vishal',
            position: 'Developer at Radiance AI',
            text: 'Very easy this was to integrate. Due to the price and the seasonal nature of our products, location shootings are typically not an option for us. We\'ve completely transformed the game thanks to Radiance AI. We are able to produce stunning lifestyle photographs in settings where we would never be able to shoot, as opposed to relying solely on standard studio shots!',
            image: Avatar1,
        },
        {
            name: 'Sravan',
